...
export default function AlumnoItem({ alumno, onEliminar, onEdit}) { //recibe el objeto alumno y la funcion onEliminar pasada desde listaAlumnos que viene de app.jsx
    ...
    <tr>
      ...
      <td>
        ...
        {/* <Link to={`/alumnos/${alumno.libreta}/editar`}> */}
          <AlumnoEditar luEditar={alumno.libreta} onEdit={onEdit}/>
        {/* </Link> */}
